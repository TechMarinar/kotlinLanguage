...
object InlineClassAbi {
    ...
    fun mangledNameFor(irFunction: IrFunction, mangleReturnTypes: Boolean, useOldMangleRules: Boolean): Name {
        if (irFunction is IrConstructor) {
            ...
            return Name.identifier("constructor${JvmAbi.IMPL_SUFFIX_FOR_MANGLED_MEMBERS}")
        }
        ...
        return Name.identifier("$base${if (suffix == null) JvmAbi.IMPL_SUFFIX_FOR_MANGLED_MEMBERS else "-$suffix"}")
    }
