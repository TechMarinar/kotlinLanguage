...
enum class WasmOp(
    ...
    ARRAY_NEW_FIXED("array.new_fixed", 0xFB_1A, listOf(STRUCT_TYPE_IDX, CONST_I32)), // TODO move up
    ARRAY_NEW_ELEM("array.new_elem", 0xFB_10, listOf(STRUCT_TYPE_IDX, DATA_IDX)),
...
//    REF_IS_DATA("ref.is_data", 0xfb51), // ref.test
//    REF_IS_I31("ref.is_i31", 0xfb52), // ref.test
//    REF_AS_DATA("ref.as_data", 0xfb59), // ref.cast
//    REF_AS_I31("ref.as_i31", 0xfb5a),// ref.cast

//    BR_ON_DATA("br_on_data", 0xfb61, listOf(LABEL_IDX)), // br_on_cast
//    BR_ON_I31("br_on_i31", 0xfb62, listOf(LABEL_IDX)),// br_on_cast

//    BR_ON_NON_DATA("br_on_non_data", 0xfb64, listOf(LABEL_IDX)), // br_on_cast_fail
//    BR_ON_NON_I31("br_on_non_i31", 0xfb65, listOf(LABEL_IDX)), // br_on_cast_fail
